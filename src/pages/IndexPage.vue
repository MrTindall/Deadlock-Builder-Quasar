...
const itemDescriptions = [
  ...
  {name:'upgrade_lifestrike_gauntlets', descriptionPassive: 'Passive (7.5s): Your melee attacks heal you for 80% of the Melee Damage dealt plus 90. This heal is 30% effective vs non-heroes.'},
  {name:'upgrade_health_stimpak',  descriptionActive: 'Active (64s): Grant Regen and Sprint Speed to the target. Gets dispelled if you take damage from enemy players or objectives. Can be self-cast.'},
  ...
  {name:'upgrade_acolytes_glove', descriptionPassive: 'Passive (8.5s): When you perform a Light or Heavy Melee attack against a hero, deal extra Spirit Damage with the attack and reduce the targets Spirit Resist.'},
  {name:'upgrade_infuser', descriptionActive: 'Active (32s): Gain Spirit Power and Spirit Lifesteal.'},
