...
const itemDescriptions = [
  ...
  {name:'upgrade_active_reload', descriptionPassive: 'Passive (18s): While reloading, pressing [R] during the highlighted portion will instantly finish your reload and grant you Fire Rate and Bullet Lifesteal.'},
  ...
  {name:'upgrade_crackshot', descriptionPassive: 'Passive (5.75s): Your next bullet deals bonus Spirit Damage.'},
  ...
  {name:'upgrade_burst_fire', descriptionPassive: 'Passive (8.5s): Briefly gain Fire Rate and Move Speed when one of your bullets hits an enemy hero.'},
  ...
  {name:'upgrade_banshee_slugs', descriptionPassive: 'Passive: Headshots reduce targets Bullet and Spirit Resist.', descriptionActive: ''},
  {name:'upgrade_fervor', descriptionPassive: 'Passive: While you are below 50% health, you gain stat bonuses.', descriptionActive: ''},
  {name:'upgrade_glass_cannon', descriptionPassive: 'Passive: Each hero kill grants permanent Weapon Damage (up to a max of 7 times). Death results in the loss of 1 stack.', descriptionActive: ''},
  {name:'upgrade_critshot', descriptionPassive: 'Passive: Your bullets have a chance to be empowered, causing them to  deal bonus damage and Slow on hit', descriptionActive: ''},
  {name:'upgrade_ricochet', descriptionPassive: 'Passive: Your bullets will ricochet on enemies near your target, applying any bullet procs and dealing percentage of the original damage.', descriptionActive: ''},
  {name:'upgrade_cloaking_device_active', descriptionPassive: '', descriptionActive: 'Active: Become Stealthed. Whenever you take damage while Stealthed you get briefly revealed.Attacking or using an ability will end your stealth and start an ambush, temporarily granting you bonus Fire Rate and Spirit Power'},
  {name:'upgrade_tech_overflow', descriptionPassive: 'Passive: Gain bonus Spirit Power by charging up with your bullets on enemy heroes.', descriptionActive: ''},
  {name:'upgrade_silencer', descriptionPassive: '', descriptionActive: 'Active (36s): For the next 4s, all your bullets immediately apply Silence. Silence prevents targets from using abilities.'},
  {name:'upgrade_surging_power', descriptionPassive: '', descriptionActive: 'Active (30s): Grants Lifesteal, Fire Rate, and Ammo. This added Ammo is not limited by your max magazine size.'},
